function [Trk ,param, Obs_grap] = MOT_Generation_Tracklets_HCF(init_img_set,Trk,detections,param,...
    Obs_grap,cfr)
...
[Trk,param,Obs_grap] = mot_generation_tracklet_HCF(init_img_set,Trk,Obs_grap,...
